                        ...
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                <div class="mb-md-4 mt-md-3 pb-4">
                                    <h2 class="fw-bold mb-4 text-uppercase">Zresetuj Hasło</h2>
                                    ...
                                    <button class="btn btn-outline-light btn-lg px-4" type="submit" name="kategoria" value="Reset">Zresetuj hasło</button>
                                </div>
                                <div>
                                    <p class="mb-0">Wróć do <a href="login.php" class="text-white-50 fw-bold">logowania</a> </p>
                                </div>
                            </div>
                        </div>
                    </div>
