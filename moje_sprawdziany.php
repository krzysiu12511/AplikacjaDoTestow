            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        ?>
                            <li class="nav-item">
                                <a class="nav-link active" style="width:145px;" href="moje_sprawdziany.php">Moje sprawdziany</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="col-12 col-sm-12 col-md-6">
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12">
                                <h1 class="fw-light center-text">Lista sprawdzianów</h1>
                            </div>
                        </div>
                    </div>
                                <?php
                    ...
                    <div class="mojesprawdziany mojagrupa">
                        <div class="container">
                            ...
                            <?php 
                            $result = mysqli_query($conn, "SELECT t.ID,t.Nazwa FROM testy t INNER JOIN grupy g ON t.id_grupy = g.ID  WHERE g.Nazwa = '$nazwa'");
                            $row = mysqli_fetch_array($result);
                            if($row != ""|| $row != null){ ?>
                            ...
                            <?php
                                $result = mysqli_query($conn, "SELECT t.ID,t.Nazwa FROM testy t LEFT JOIN grupy g ON t.id_grupy = g.ID  WHERE t.id_user = '$_SESSION[Userid]' OR g.Nazwa = '$nazwa'");
                                ...
                                <div class="row center-text">
                                    <div class="col-9 col-sm-9 col-md-9">
                                        <p>Nie masz aktualnie żadnego testu</p>
                                    </div>
                                </div>
                            <?php
                            }
